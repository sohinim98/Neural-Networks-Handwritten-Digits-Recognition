...
%% Setup the parameters to be used for regularized logistic regression
...
%  In this part, we will reuse your logistic regression
%  code from the last part. Our task here is to make sure that our
